            ...
            <div class="form-side">
                ...
                <b-form @submit.prevent="formSubmit" class="av-tooltip tooltip-label-bottom">
                    <b-form-group :label="$t('code')" class="has-float-label mb-4">
                        ...
                        <b-form-invalid-feedback v-if="!$v.form.email.required">Please enter the code</b-form-invalid-feedback>
                    </b-form-group>
    ...
    methods: {
        ...
        formSubmit() {
            ...
            if (!this.$v.form.$anyError) {
                ...
                this.$Axios.post('/verifyCode',data)
                .then(res =>{
                     localStorage.setItem('token',res.data)
                     this.$router.push('/user/reset-password')
                })
                .catch(e =>  {
                     this.$notify("error", "Reset Password", "Wrong Code", {
                            duration: 3000,
                            permanent: false
                        });
                })
