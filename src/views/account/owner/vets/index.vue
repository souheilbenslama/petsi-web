...
import VetThumbListItem from "@/components/Listing/VetThumbListItem";
...
export default {
  components: {
    ...
    "v-select": vSelect,
    "vet-thumb-list-item": VetThumbListItem
  },
  data() {
    return {
      file1: null,
  ...
  computed: {
    ...
    filtredItems() {
      ...
      if(this.search){
          Items = Items.filter(pet => pet[this.sort.column].includes(this.search))
      }
