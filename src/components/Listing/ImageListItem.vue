    ...
    <b-card-body>
        <b-row>
            <b-colxx xxs="10" class="mb-3">
                ...
                <p class=" text-small mb-0 font-weight-light card-text">{{data.date}}</p>
            </b-colxx>
        </b-row>
        <b-row>
            <b-colxx xxs="10" class="mb-3">
